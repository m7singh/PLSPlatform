...
using Property.Rest.Repository.Interface;
using Property.Rest.Repository.Concrete;


namespace Property.Rest.Repository.Context
{
    public static class DbContext
    {
        ...
        private static IRepository GetOrCreateSession()
        {
            ...
            if (session == null)
            {
                session = (IRepository)new MongoRepository(); //ObjectFactory.GetInstance<IRepository>();
